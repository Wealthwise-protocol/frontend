...
export function Hero() {
  ...
  return (
    <section className="relative mx-auto max-w-6xl overflow-hidden px-4 pt-20 pb-16 sm:px-6 md:pt-32 md:pb-28">
      ...
      <FadeIn>
        <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5 text-[0.65rem] text-muted-foreground card-shadow">
      ...
      <FadeIn delay={0.1}>
        <h1 className="mt-6 max-w-3xl text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
          Stop guessing.{" "}
      ...
      <FadeIn delay={0.5}>
        <div className="mt-12 overflow-hidden rounded-xl border border-border bg-card card-shadow-lg md:mt-16">
          ...
          <div className="grid gap-px bg-border sm:grid-cols-3">
            <div className="bg-card p-4 sm:p-5">
              ...
              <p className="mt-1.5 text-lg font-bold sm:text-xl num">
                ₹12,45,800
              </p>
              <p className="mt-1 text-[0.65rem] num-positive">
                +18.4% all time
              </p>
            </div>
            <div className="bg-card p-4 sm:p-5">
              <p className="section-label">Active SIPs</p>
              <p className="mt-1.5 text-lg font-bold sm:text-xl num">7</p>
            ...
            <div className="bg-card p-4 sm:p-5">
              ...
              <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                <span className="text-primary">"</span>Your small-cap
                allocation is 40% — consider rebalancing to reduce
                volatility.<span className="text-primary">"</span>
              </p>
            </div>
          </div>
        </div>
